...
public class Java21Features {
    ...
    // Small, compatible demonstration for records that works on Java 21 and earlier
    static void demonstrateRecords() {
        System.out.println("\n5. Records:");
        Point p1 = new Point(3, 4);
        Point p2 = new Point(0, 0);
        System.out.println("Point 1: " + p1);
        System.out.println("Point 1 distance from origin: " + Math.sqrt(p1.x() * p1.x() + p1.y() * p1.y()));
        System.out.println("Point 2: " + p2);
        System.out.println("Point 2 distance from origin: " + Math.sqrt(p2.x() * p2.x() + p2.y() * p2.y()));
    }
}